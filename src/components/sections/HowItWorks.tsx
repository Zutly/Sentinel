        ...
        <div className="grid gap-5 md:grid-cols-3">
          {steps.map((step, index) => (
            <SectionReveal
              ...
              delay={100 + index * 100}
            >
              <Card className="group flex h-full flex-col gap-3 border-[#BFBDC1]/20 bg-[#6D6A75]/40 p-5 transition-transform duration-300 hover:-translate-y-1 hover:border-[#DEB841]/40">
